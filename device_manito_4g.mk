...
$(call inherit-product-if-exists, vendor/cubot/manito_4g/manito_4g-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/cubot/manito_4g/overlay
PRODUCT_PACKAGE_OVERLAYS += device/cubot/manito_4g/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/cubot/manito_4g
